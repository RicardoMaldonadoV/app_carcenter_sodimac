...
SELECT * FROM dual;
INSERT ALL
   INTO cliente VALUES(0,'Nombre1-1','Nombre2-1', 'Apellido1-1', 'Apellido2-1', 1, 1234561, 3101234561, 'correo1@corre.com', 'cra 1 Nro 3-1', 1, 1, 1)
   INTO cliente VALUES(0,'Nombre1-2','Nombre2-2', 'Apellido1-2', 'Apellido2-2', 1, 1234562, 3101234562, 'correo2@corre.com', 'cra 1 Nro 3-2',3 , 4, 4)
   INTO cliente VALUES(0,'Nombre1-3','Nombre2-3', 'Apellido1-3', 'Apellido2-3', 1, 1234563, 3101234563, 'correo3@corre.com', 'cra 1 Nro 3-3', 1, 1, 1)
   INTO cliente VALUES(0,'Nombre1-4','Nombre2-4', 'Apellido1-4', 'Apellido2-4', 1, 1234564, 3101234564, 'correo4@corre.com', 'cra 1 Nro 3-4', 2, 2, 2)
   INTO cliente VALUES(0,'Nombre1-5','Nombre2-5', 'Apellido1-5', 'Apellido2-5', 1, 1234565, 3101234565, 'correo5@corre.com', 'cra 1 Nro 3-5', 4 ,5, 5)
   INTO cliente VALUES(0,'Nombre1-6','Nombre2-6', 'Apellido1-6', 'Apellido2-6', 1, 1234566, 3101234566, 'correo6@corre.com', 'cra 1 Nro 3-6', 2, 3, 3)
   INTO cliente VALUES(0,'Nombre1-7','Nombre2-7', 'Apellido1-7', 'Apellido2-7', 1, 1234567, 3101234567, 'correo7@corre.com', 'cra 1 Nro 3-7', 1, 1, 1)
   INTO cliente VALUES(0,'Nombre1-8','Nombre2-8', 'Apellido1-8', 'Apellido2-8', 1, 1234568, 3101234568, 'correo8@corre.com', 'cra 1 Nro 3-8', 2, 2, 2)
   INTO cliente VALUES(0,'Nombre1-9','Nombre2-9', 'Apellido1-9', 'Apellido2-9', 1, 1234569, 3101234569, 'correo9@corre.com', 'cra 1 Nro 3-9', 3 , 4, 4)
   INTO cliente VALUES(0,'Nombre1-10','Nombre2-10', 'Apellido1-10', 'Apellido2-10', 1, 12345610, 3101234510, 'correo10@corre.com', 'cra 1 Nro 3-10', 1, 1, 1)
   INTO cliente VALUES(0,'Nombre1-11','Nombre2-11', 'Apellido1-11', 'Apellido2-11', 1, 12345611, 3101234511, 'correo11@corre.com', 'cra 1 Nro 3-11',4 ,5, 5)
   INTO cliente VALUES(0,'Nombre1-12','Nombre2-12', 'Apellido1-12', 'Apellido2-12', 1, 12345612, 3101234512, 'correo12@corre.com', 'cra 1 Nro 3-12', 1, 1, 1)
   INTO cliente VALUES(0,'Nombre1-13','Nombre2-13', 'Apellido1-13', 'Apellido2-13', 1, 12345613, 3101234513, 'correo13@corre.com', 'cra 1 Nro 3-13', 2, 2, 2)
   INTO cliente VALUES(0,'Nombre1-14','Nombre2-14', 'Apellido1-14', 'Apellido2-14', 1, 12345614, 3101234514, 'correo14@corre.com', 'cra 1 Nro 3-14', 4 ,5, 5)
   INTO cliente VALUES(0,'Nombre1-15','Nombre2-15', 'Apellido1-15', 'Apellido2-15', 1, 12345615, 3101234515, 'correo15@corre.com', 'cra 1 Nro 3-15', 2, 3, 3)
SELECT * FROM dual;
INSERT ALL
...
SELECT * FROM dual;
INSERT ALL
   INTO vehiculo VALUES(0,'ABC-121','CarMan',2020, 'Almandra', 1,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-122','CarMan',2020, 'Almandra', 2,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-123','CarMan',2020, 'Almandra', 3,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-124','CarMan',2020, 'Almandra', 4,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-125','CarMan',2020, 'Almandra', 5,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-126','CarMan',2020, 'Almandra', 6,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-127','CarMan',2020, 'Almandra', 7,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-128','CarMan',2020, 'Almandra', 8,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-129','CarMan',2020, 'Almandra', 9,  0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-210','CarMan',2020, 'Aguapane', 10, 0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-211','CarMan',2020, 'Aguapane', 11, 0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-212','CarMan',2020, 'Aguapane', 12, 0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-213','CarMan',2020, 'Aguapane', 13, 0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-214','CarMan',2020, 'Aguapane', 14, 0, SYSDATE)
   INTO vehiculo VALUES(0,'ABC-215','CarMan',2020, 'Aguapane', 15, 0, SYSDATE)
SELECT * FROM dual;
INSERT ALL
...
SELECT * FROM dual;
INSERT ALL
   INTO mantenimiento VALUES(0, 1, 'terminado', 1, 1, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 1, 'terminado', 2, 2, 'Retrovisor roto', 150000, null)
   INTO mantenimiento VALUES(0, 2, 'terminado', 3, 3, 'No enciende', 200000, null)
   INTO mantenimiento VALUES(0, 2, 'terminado', 4, 4, 'llanta con problemas', 200000, null)
   INTO mantenimiento VALUES(0, 3, 'terminado', 5, 5, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 3, 'terminado', 6, 6, 'Check encendido', 200000, null)
   INTO mantenimiento VALUES(0, 4, 'terminado', 7, 7, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 4, 'terminado', 8, 8, 'llanta con problemas', 200000, null)
   INTO mantenimiento VALUES(0, 5, 'terminado', 9, 9, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 5, 'terminado', 10, 10, 'Frenos duros', 200000, null)
   INTO mantenimiento VALUES(0, 6, 'terminado', 11, 11, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 6, 'terminado', 12, 12, 'No enciende el carro', 200000, null)
   INTO mantenimiento VALUES(0, 1, 'terminado', 13, 13, 'Retrovisor roto', 200000, null)
   INTO mantenimiento VALUES(0, 1, 'terminado', 14, 14, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 2, 'terminado', 15, 15, 'Check encendido', 200000, null)
   INTO mantenimiento VALUES(0, 3, 'terminado', 1, 1, 'Cambio de llantas', 2000000, null)
   INTO mantenimiento VALUES(0, 4, 'En proceso', 1, 1, 'Cambio rines', 2200000, null)
   INTO mantenimiento VALUES(0, 5, 'En proceso', 5, 5, 'No encienden las luces', 200000, null)
   INTO mantenimiento VALUES(0, 6, 'En proceso', 6, 6, 'Check encendido', 200000, null)
SELECT * FROM dual;
INSERT ALL
